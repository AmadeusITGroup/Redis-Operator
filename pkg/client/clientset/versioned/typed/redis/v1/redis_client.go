...
// RedisV1Client is used to interact with features provided by the redis.k8s-operator.io group.
type RedisV1Client struct {
	restClient rest.Interface
}

func (c *RedisV1Client) RedisClusters(namespace string) RedisClusterInterface {
